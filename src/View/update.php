...
<main class="bg-zinc-700">
    ...
    <div class="p-4 overflow-auto h-full">
        <div class="update__wrapper mx-auto">
            <div>
            <div class="md:col-span-1 mb-2">
                <div class="px-4 sm:px-0">
                <h3 class="ml-6 text-lg font-medium leading-6 font-bold text-white">Profile</h3>
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-zinc-800 space-y-6 sm:p-6">
                        <div class="grid gap-6">
                            ...
                            <label for="email-adress-icon" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your Email</label>
                                ...
                                <input type="text" id="email" name="email" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus: block w-full pl-10 p-2.5  dark:dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="<?= $_SESSION['email'] ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="mb-6">
                        <label for="password" class="block mb-2 text-sm font-medium text-gray-200 dark:text-gray-300">Your password</label>
                        <input type="password" id="password" name="password" class=" w-full bg-white border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark: dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-600" placeholder="•••••••" required>
                    </div>
                    ...
                    <div>
                        ...
                        <img class="rounded-full"
                            ...
                            height="50"
                            loading="lazy">
                        <input name="fileToUpload" id="fileToUpload" class="w-full p-2.5 text-sm ml-4 text-gray-900 bg-gray-50 rounded-lg border border-gray-300" aria-describedby="user_avatar_help" type="file" required>
        ...
        <a class="px-4 py-2 w-full rounded-md bg-red-700 mt-4 flex items-center justify-center" href="index.php?mod=user&action=logout">Déconnexion</a>
    </div>
</main>